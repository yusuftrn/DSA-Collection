/*
 ...
 Difficulty: Easy Write a function that accepts a String as its only parameter, and returns true if the string reads the same when reversed, ignoring case.
...
func challenge2(input: String) -> Bool {
  ...
  return lower.reversed() == Array(lower)
}
